...
// Saare callbacks aur commands register ho gaye bhai
...
bot.command("admin", async (ctx) => {
    ...
    await ctx.reply(`⚙️ *HAPPY REACTION Admin Control Panel*\n\nBhai tumhara admin access 100% active hai!`, { parse_mode: "Markdown" });
});
...
bot.on("message:text", async (ctx) => {
    ...
    if (u.awaiting_utr) {
        ...
        await ctx.reply(`💌 *Request Submitted!* ✅\n\nRef \`${txt}\` verification ke liye bhej diya gaya hai bhai!`);
        return;
    }
